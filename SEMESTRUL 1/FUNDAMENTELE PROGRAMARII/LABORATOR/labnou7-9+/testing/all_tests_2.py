...
class TestWithSetupB(unittest.TestCase):
    def setUp(self):
        # client, client_repo
        self.path_c=r"D:\FMI UBB CLUJ 2023-2026\FUNDAMENTELE PROGRAMARII\LABORATOR\labnou7-9+\testing\test_clients.txt"
        ...
        self.client_r = self.repo_c.add_client(self.client)
        # movie,movie_repo
        self.path_m=r"D:\FMI UBB CLUJ 2023-2026\FUNDAMENTELE PROGRAMARII\LABORATOR\labnou7-9+\testing\test_movies.txt"
        ...
        # rentals
        self.val_r = ValidatingRentals()
        self.path_rentals=r"D:\FMI UBB CLUJ 2023-2026\FUNDAMENTELE PROGRAMARII\LABORATOR\labnou7-9+\testing\test_rentals.txt"
